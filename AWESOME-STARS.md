...
- [hellof2e/quark](https://github.com/hellof2e/quark) - Low-cost, cross-stack and framework-free: reimagining the next generation of front-end components! Based on Web Components.低成本构建你的跨技术栈/原生组件。低成本、跨技术栈与无框架：重新构想下一代前端组件！
...
- [cocacola-lab/ChatIE](https://github.com/cocacola-lab/ChatIE) - official repository for ChatIE paper and a tool of  IE using ChatGPT. Note: we set defaul openai key. See issues for the solution of gpt3.5-turbo request limit.  The response speed depends on openai. 
...
- [zhiyiYo/PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) - A fluent design widgets library based on PyQt/PySide.
