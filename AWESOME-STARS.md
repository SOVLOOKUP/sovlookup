...
- [Aethersailor/SubConverter-Extended](https://github.com/Aethersailor/SubConverter-Extended) - 基于 subconverter 深度演进的多客户端订阅转换后端，重点优化 Mihomo 格式适配，并持续完善 Surge、Quantumult X、Loon、Surfboard、Stash、Sing-box、Shadowrocket 等目标格式。支持 Mihomo 原生节点解析与 Proxy Provider、客户端原生远程资源、传统订阅及分享链接转换，可减少或避免后端代取订阅造成的限制；兼容 s
