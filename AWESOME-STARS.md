...
- [hellof2e/quark-core](https://github.com/hellof2e/quark-core) - ⭐️ ⭐️ ⭐️ ⭐️ ⭐️   Fast 4Kb size! Write once, run everywhere(React, Vue, Qwik, Solid, Angular, Svelte, and more.)（低成本、无框架、跨技术栈，构建你的跨技术栈/原生组件或应用。可运行于任何前端框架！）
